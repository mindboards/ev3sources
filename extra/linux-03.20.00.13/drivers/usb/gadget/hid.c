...
#define HIDG_VENDOR_NUM		0xaaaa	/* XXX NetChip */
#define HIDG_PRODUCT_NUM	0x5555	/* Linux-USB HID gadget */
...
static struct usb_device_descriptor device_desc = {
	...
	/* .bDeviceSubClass =	0, */
	/* .bDeviceProtocol =	0, */
	.bDeviceClass =		0,	// HER_PER 0xEF,
	.bDeviceSubClass =	0,	// HER_PER 2,
	.bDeviceProtocol =	0,	// HER_PER 1,
