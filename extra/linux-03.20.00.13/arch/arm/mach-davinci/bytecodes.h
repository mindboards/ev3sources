...
#define   vmFILENAMESIZE                120                           //!< Max filename size including path, name, extension and termination
...
#define   vmDETAILS_FILE                "Brick Info"

// EXTENSIONS

#define   vmEXT_SOUND                   ".rsf"                        //!< rudolf sound file
#define   vmEXT_GRAPHICS                ".rgf"                        //!< rudolf graphics file
#define   vmEXT_BYTECODE                ".rbf"                        //!< rudolf byte code file
#define   vmEXT_TEXT                    ".rtf"                        //!< rudolf text file
#define   vmEXT_DATALOG                 ".rdf"                        //!< rudolf datalog file
#define   vmEXT_PROGRAM                 ".rpf"                        //!< rudolf program file
...
//!
//! \todo subcode align sequence to start from 1 with no "holes"
//!
//! \verbatim
//!
...
typedef   enum
{
  ...
  BUTTONTYPES                   = 6,    //!< Maximum number of buttons supported by the VM
  ANY_BUTTON                    = 7
}
BUTTONTYPE;
...
typedef   enum
{
  ...
  DATA_PCT      = 0x10 + DATA_8,        //!< Percent (used in opINPUT_READEXT)
  DATA_RAW      = 0x10 + DATA_32,       //!< Raw     (used in opINPUT_READEXT)
  DATA_SI       = 0x10 + DATA_F,        //!< SI unit (used in opINPUT_READEXT)
...
#define   DATA8_NAN     (0x80)
#define   DATA16_NAN    (0x8000)
